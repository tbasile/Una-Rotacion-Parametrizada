...
\tbnote{O algo como lo siguiente:}
...
simulating Pauli channels on one of IBM's quantum computers
...
under which a parametrized quantum circuit requires only one single-qubuit rotation dependent on the parameter.
...
and we find the big effect that the error of quantum computers have
on these simulations.
On the other hand, the result
of theorem \ref{theorem2}
can be used for any quantum algorithm that requires parametrized circuits,
