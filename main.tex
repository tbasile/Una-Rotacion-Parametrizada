...
\end{subfigure}
\caption{\cpnote{}\tbnote{Aquí está una forma alternativa en que puede quedar la figura. 
Usé $2(1-p_{succ})$ en lugar de $p_{succ}$ para que se cumpla lo de
...
\cpnote{no me salen esas cuentas.} \tbnote{Se me olvidaba el 2, ya está bien}
