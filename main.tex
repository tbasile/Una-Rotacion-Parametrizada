...
\epsilon_{\alpha \beta \gamma} \sigma_\gamma$ and $\epsilon_{\alpha \beta \gamma} \sigma_\gamma$ is 
...
\revnote{At this point I am missing a proper definition of a "quantum circuit"
consistent with the mathematical formalism. The authors start from the very
basic regarding Pauli channels, but give for granted the quantum circuit
formalism.} 
