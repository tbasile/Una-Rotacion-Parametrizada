...
systems~\cite{cleve,Zanetti,Xin,Wei}.\cpnote{porque escogiste estas citas? Me parece qeu la ce cleve no está completa.} \tbnote{La primera habla al principio en general
de simulación de sistemas abiertos y los otros tres porque se relacionan más con este trabajo
porque lo hacen en particular con el formalismo de canales cuánticos}
...
controlled \cpnote{el caso general es controlado, correcto?} \tbnote{Sí} single-qubit
...
\cpnote{Sigue estando redundante. Dices que cuales se pueden implentar con 1pr circuit y que 
enticones tiene que ser construidas con un 1pr. Quizá integra las dos frases o has algo}
...
\tbnote{Ah, es que más bien la idea era primero decir que el siguiente paso es
usar una matriz unitaria (con la condición
mencionada sobre el primer renglón)
y explicar cómo la usamos y por qué.
Ya luego mostrar cómo se puede construir dicha 
matriz al azar. También se puede hacer al revés,
pero no me convencía decir todo lo de cómo 
construir la matriz sin decir antes para qué}
.
