...
%
%\end{thebibliography}
\cpnote{Revisa con cuidado la bibliografia. Los nombres parece que estan bien, pero los doi parece que no estan completos. Hay nombres de revistas raros. Cre oque en plos one se abrevian, pero entonces haslos otodos abreviavos. Revis que todos tengan año, numero y pagina y que esté homogeneo. Revisa con cuidaod como son las abreviaciones de los journals (son estandard pero no recuerdo odnde está esa informacion). Ver revisando el procedimiento para someter a Plos One y al arxiv. Avisame cuando estes listo. }
