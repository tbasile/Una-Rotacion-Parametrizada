...
simular un mapa dinámico (en lugar de simular canales de Pauli asi nada mas)  y estudiar como entra el parámetro en juego. 
Podemos decir que aunque en general se ha hecho mucha simulación cuántica, 
no se le ha dado mucho enfoque a operaciones parametrizadas.\\
...
También corremos el circuito en compus cuánticas,
