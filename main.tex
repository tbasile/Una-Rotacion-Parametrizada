...
\cpnote{No se sabe aun que son OPR circuits. Poner completo}
...
\cpnote{no me salen esas cuentas.}
...
states can be generated using OPR \cpnote{Si te parece bien el cambio 
en la sigla, cambialos todos} circuits. 
...
que Latex organice solo las figuras y sin ponerle el h! ni nada. }
}
...
poner en el planteamiento del problema.}
$\blacksquare$ \\
$\;$\\
...
\end{eqnarray}
\cpnote{que denota el valor absoluto?}
