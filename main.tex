...
\centering
\includegraphics[width=.95\columnwidth]{images/tetra-def.pdf}
\end{subfigure}%
\begin{subfigure}{.333\textwidth}
\includegraphics[width=.95\columnwidth]{images/corte1-2.pdf} \\
\includegraphics[width=.95\columnwidth]{images/corte2-2.pdf} \\
\end{subfigure}
\includegraphics[width=.322\columnwidth]{images/corte3-2.pdf}
\includegraphics[width=.322\columnwidth]{images/corte4-2.pdf}
\includegraphics[width=.322\columnwidth]{images/corte5-2.pdf}
\end{subfigure}%
\begin{subfigure}{0.1\textwidth}
\includegraphics[width=.8\columnwidth]{images/col-2.pdf} \\ [2ex]
\end{subfigure}
...
\begin{subfigure}{.45\textwidth}
  \centering
  \includegraphics[width=.9\linewidth]{images/curvas.pdf}
   \caption{}
\end{subfigure}%
\begin{subfigure}{.45\textwidth}
  \centering
  \includegraphics[width=.9\linewidth]{images/curvas-azar.pdf}
  \caption{}
\end{subfigure}
