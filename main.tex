...
which are described by the theory of quantum
...
\cpnote{Aca citar nuestros trabajos con Davalos. }
...
has to be constructed with only one parametrized rotation\cpnote{no entiendo esta frase}. 
...
this curve of states is \cpnote{supongo qeye hay muchas curvas. Es correcto eso? Quizá un ``this curve of states can be'' sea mas preciso.}
\begin{align*}
...
\cpnote{este mapa no es muy comun. Toca comentar algo al respecto. No se si acá o mas arriba. Si, ya se donde. En el parrafo antes de los ejemplos. }
\begin{eqnarray}
