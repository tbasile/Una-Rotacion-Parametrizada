...
In this article, our primary objective is to present a 
...
parametrized quantum circuit, that is, 
a quantum circuit in which some of the
 operations depend on a variable parameter~\cite{cerezo}. 
...
In this article, we contribute to this body of work by establishing theorem \ref{theorem2},
which outlines the types of transformations that 
can be done using a parametrized quantum with the condition that only one
