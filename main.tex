...
\tbnote{Cambié un poco, agregué unos artículos que vi mucho más populares:}
{\color{purple} 
open quantum systems~\cite{Garcia, Wang,Weimer} and specifically for
quantum channels~\cite{Xin,Wei,Zanetti}.
}
