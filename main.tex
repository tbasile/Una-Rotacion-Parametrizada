...
% eq.~(\ref{eq: pauli channel N-qubit}), applies each Pauli operator
...
\caption{
% \cpnote{si quieres, intenta hacer la figura tu solo basado en el lo quehabía hecho.} \tbnote{Va, lo hice así, espero haberlo hecho bien.} \cpnote{ 
...
el lugar apropiado en el texto}
...
Tambien poner mas puntos experimentales.}}
