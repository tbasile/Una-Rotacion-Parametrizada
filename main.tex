...
As the number of qubits gets bigger, the degrees of freedom for choosing a Pauli dynamical map also gets bigger,
so we would expect that the space of maps that can be done with only 
one parameter
becomes a smaller part of the whole space of Pauli dynamical maps.
However, some paradigmatic maps as the dephasing one we studied for 2 qubits in section \ref{2qbit} will still be
