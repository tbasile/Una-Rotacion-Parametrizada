...
+ \sum_{k \not\in \mathcal{C}} \left( B_{2k,j} |k\rangle |0\rangle + B_{2k+1}
|k\rangle |j \rangle \right) \nonumber \\
& = e^{-is} \vec{b'}_j + e^{is} \vec{a'}_j + \vec{c'}_j,
\end{align}
where $\vec{a'} = \sum_{k \in \mathcal{C}} B_{2k,j}|k\rangle|0\rangle$,
$\vec{b'}_j = \sum_{k \in \mathcal{C}} B_{2k+1,j} |k\rangle |1 \rangle$,
$\vec{c'}_j =\sum_{k \not\in \mathcal{C}} \big( B_{2k,j} |k\rangle |0\rangle+$
$ B_{2k+1} |k\rangle |j \rangle \big)$.
...
algo que decir de su contenido.}
